...
import { Music, Play, Calendar, MapPin, Instagram, Youtube, Mail, Guitar } from 'lucide-react'
import './App.css'
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      {/* Section Hero */}
      <section id="accueil" className="hero-section flex items-center justify-center relative">
        <div 
        ...
        <div className="relative z-10 text-center text-white px-6">
          <div className="fade-in">
            <img 
              src={kaderPhoto} 
              alt="Kader Tarhanine" 
              className="w-64 h-64 rounded-full mx-auto mb-8 object-cover border-4 border-white/30 shadow-2xl"
            />
            <h1 className="text-6xl md:text-8xl font-bold mb-4 slide-in-left">
              Kader Tarhanine
            </h1>
              ...
              <Card className="hover-lift">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow">
                      <div>
                        <h4 className="font-semibold">Meddane Taknassam</h4>
                        <p className="text-gray-600">Single • 2024</p>
                      </div>
                      <Button size="sm" className="bg-orange-600 hover:bg-orange-700">
                        <Play size={16} />
                    ...
                    <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow">
                      <div>
                        <h4 className="font-semibold">Zain Assahra</h4>
                        <p className="text-gray-600">Single • 2024</p>
                      </div>
                      <Button size="sm" className="bg-orange-600 hover:bg-orange-700">
                        <Play size={16} />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="hover-lift">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-6 desert-orange">Prochaines Dates</h3>
                  <div className="text-center py-12">
                    <Calendar size={64} className="mx-auto mb-4 text-gray-400" />
                    <p className="text-gray-600 text-lg">
                      Nouvelles dates de tournée à venir
                    </p>
                    <p className="text-gray-500 mt-2">
                      Restez connectés pour les annonces
                    </p>
                  </div>
                </CardContent>
              </Card>
