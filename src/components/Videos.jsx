        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {clips.map((clip) => (
                <Card key={clip.id} className="overflow-hidden hover-lift group cursor-pointer" onClick={() => openVideo(clip.url)}>
                  <div className="relative">
                    <img 
                      ...
                      onError={(e) => {
                        e.target.src = 'https://via.placeholder.com/480x270/f97316/ffffff?text=Video'
                      }}
                    />
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {concerts.map((concert) => (
                <Card key={concert.id} className="overflow-hidden hover-lift group cursor-pointer" onClick={() => openVideo(concert.url)}>
                  <div className="relative">
                    <img 
                      ...
                      onError={(e) => {
                        e.target.src = 'https://via.placeholder.com/640x360/f97316/ffffff?text=Concert+Live'
                      }}
                    />
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="bg-orange-600 rounded-full p-4">
